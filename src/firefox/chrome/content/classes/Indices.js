PowerCab.Indices = {
	items : [
		...
		{img:"worldin.png", path:'/opt/traf_cnt[@name="west"]/@rx', bit:0x100, label:"indlabel.worldinput"},
		{img:"worldout.png", path:'/opt/traf_cnt[@name="west"]/@tx', bit:0x200, label:"indlabel.worldoutput"},
